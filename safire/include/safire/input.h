...
SAFIRE_API SFRkeybinding_t* sfr_input_keyboard_get_current(SFRaction_t action);
SAFIRE_API SFRmouse_binding_t* sfr_input_mouse_get_current(SFRaction_t action);
